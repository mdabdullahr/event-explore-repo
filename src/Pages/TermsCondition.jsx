...
const TermsCondition = () => {
    useEffect(() => {
      ...
      return (
        <div className="max-w-4xl mx-auto text-gray-300 p-6 space-y-4 mt-10 lg:mt-20 shadow-xl shadow-[#34116241]">
          <h1 className="text-3xl font-bold text-secondary mb-4">Terms and Conditions</h1>
          <p>
