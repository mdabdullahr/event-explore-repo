    ...
    return (
        <div className='w-11/12 lg:w-9/12 mx-auto my-10'>
            <div>
                ...
                <h1 className='text-xl md:text-3xl lg:text-5xl xl:text-6xl font-bold text-primary my-5'>{name}</h1>
            ...
            <div className='mt-10  p-5 md:p-10 shadow-md shadow-error'>
                <form onSubmit={handleReserve} className="mt-6 space-y-4">
                    <h2 className='text-2xl font-bold text-primary text-center mt-5'>Reserve A Seat</h2>
                    ...
                    <input
                        ...
                        required
                    />
                    <button type="submit" className="mt-5 bg-secondary w-full text-sm md:text-xl text-primary font-semibold py-3">Reserve Seat</button>
                </form>
            </div>
        </div>
    );
